...
export const LIVRAISON_CONFIG = {
  PRIX_BASE: 500,            // FCFA — prise en charge
  ...
  // Facteur de correction : la route est plus longue que le vol d'oiseau
  FACTEUR_ROUTE: 1.3,        // +30% pour approcher la distance réelle
} as const;

/**
 * Distance à vol d'oiseau (formule de Haversine)
 * GRATUIT, LÉGER, aucune API externe
 */
...
/**
 * Distance estimée "route" = vol d'oiseau × facteur de correction
 */
