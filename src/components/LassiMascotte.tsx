...
export function LassiMascotte({
  ...
  const anim: AnimResolved =
    animation === 'auto' ? FORME_ANIM[forme] : (animation as AnimResolved);
  ...
  useEffect(() => {
    AccessibilityInfo.isReduceMotionEnabled().then(v => { reducedRef.current = v; });
  ...
  useEffect(() => {
    ...
    const loop = Animated.loop(
      Animated.sequence([
        Animated.parallel([
          Animated.timing(glowSc, { toValue: 1.12, duration: 1500, easing: Easing.inOut(Easing.sin), useNativeDriver: true }),
          Animated.timing(glowOp, { toValue: 0.42, duration: 1500, easing: Easing.inOut(Easing.sin), useNativeDriver: true }),
        ]),
        Animated.parallel([
          Animated.timing(glowSc, { toValue: 0.85, duration: 1500, easing: Easing.inOut(Easing.sin), useNativeDriver: true }),
          Animated.timing(glowOp, { toValue: 0.15, duration: 1500, easing: Easing.inOut(Easing.sin), useNativeDriver: true }),
        ]),
      ]),
    );
  ...
  useEffect(() => {
    ...
    if (anim === 'peek') {
      ...
      const enter = Animated.parallel([
        Animated.timing(translateY, { toValue: -10, duration: 380, easing: Easing.out(Easing.back(1.2)), useNativeDriver: true }),
    ...
    // ── FLY ──────────────────────────────────────────────────────────────────
      ...
      const flyX = Animated.loop(
        Animated.sequence([
          Animated.timing(translateX, { toValue: 52,  duration: DUR, easing: Easing.inOut(Easing.sin), useNativeDriver: true }),
          Animated.timing(translateX, { toValue: -52, duration: DUR, easing: Easing.inOut(Easing.sin), useNativeDriver: true }),
        ]),
      ...
      const flyY = Animated.loop(
        Animated.sequence([
          Animated.timing(translateY, { toValue: -6, duration: 1200, easing: Easing.inOut(Easing.sin), useNativeDriver: true }),
          Animated.timing(translateY, { toValue:  6, duration: 1200, easing: Easing.inOut(Easing.sin), useNativeDriver: true }),
        ]),
        boucle ? undefined : { iterations: 1 },
      );
    ...
    // ── JELLY ─────────────────────────────────────────────────────────────────
      ...
      const jellyY = Animated.sequence([
        Animated.delay(60),
        Animated.timing(translateY, { toValue: -38, duration: 280, easing: Easing.out(Easing.quad), useNativeDriver: true }),
        Animated.timing(translateY, { toValue:   0, duration: 220, easing: Easing.in(Easing.quad),  useNativeDriver: true }),
      ...
      const jX = Animated.sequence([
        Animated.delay(60),
        Animated.timing(scaleX, { toValue: 0.90, duration: 280, useNativeDriver: true }),
