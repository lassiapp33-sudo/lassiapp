    ...
    >
      ...
      >
        ...
        <View style={profileRowStyles.grp}>
          <ProfileOptionRow icon={<IcoOrder />} title={t.profile.myOrders}   subtitle={t.profile.myOrdersSub} onPress={onOrders} />
          <ProfileOptionRow icon={<IcoStar />}  title={t.profile.myFavorites} subtitle={favSubtitle} onPress={onFavorites} />
          <ProfileOptionRow icon={<IcoCard />}  title={t.profile.myPayments}  subtitle={t.profile.myPaymentsSub} last
