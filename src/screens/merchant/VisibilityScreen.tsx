...
import {
  VisibilityPlan, ActiveSub, PayMethod,
  getVisibilityPlans, getActiveSub,
  createVisibilityPayment, verifyVisibilityPayment,
  ...
  const handlePay = async () => {
    ...
    try {
      ...
      if (result.status === 'awaiting_keys') {
        ...
        setKeysAvailable((prev) => ({ ...prev ?? { wave: false, orange_money: false }, [payMethod]: false }));
        return;
      }
