  ...
  return (
    <View style={styles.root}>
      ...
      >
          ...
          <View style={styles.idInfo}>
            ...
            <View style={styles.chip}>
              <Text style={styles.chipTxt}>
                {isVip ? t.profile.merchantVip : t.profile.merchant}
              </Text>
            </View>
          </View>
        ...
        <Text style={styles.secLbl}>{t.profile.myBusiness}</Text>
        <View style={styles.grp}>
          <OptionRow icon={<IcoGrid />}   title={t.profile.myStore}      subtitle={t.profile.myStoreSub}      onPress={onStore} />
          <OptionRow icon={<IcoTrend />}  title={t.profile.myVisibility} subtitle={t.profile.myVisibilitySub} onPress={onVisibility} />
          <OptionRow icon={<IcoDollar />} title={t.profile.myRevenue}    subtitle={t.profile.myRevenueSub}    onPress={onRevenue} />
          <OptionRow icon={<IcoWallet />} title={t.profile.myPayments}   subtitle={t.profile.myPaymentsSub}   onPress={onPayments} />
          <OptionRow icon={<IcoBag />}    title="Mes achats"             subtitle="Commandes passées chez d'autres" onPress={onMyOrders} last />
        </View>
        ...
        <View style={styles.grp}>
          ...
          />
          <OptionRow icon={<IcoCard />} title={t.profile.merchantNumber} subtitle={t.profile.merchantNumberSub} last />
        </View>
        ...
        <Text style={styles.version}>{t.profile.versionPro}</Text>
      </ScrollView>
