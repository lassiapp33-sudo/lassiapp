...
export default function MerchantProfileScreen({ onStore, onVisibility, onLogout }: Props) {
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.idCard}>
          <View style={styles.avatarMerch}>
            <Text style={styles.avatarMerchTxt}>{displayInitial}</Text>
          </View>
          <View style={styles.idInfo}>
            ...
            <View style={styles.chip}>
              <Text style={styles.chipTxt}>🏪 Commerçant · Top 3 VIP</Text>
            </View>
          </View>
        ...
        <View style={styles.statsRow}>
          <View style={styles.statCard}>
            <Text style={styles.statVal}>324</Text>
          ...
          <View style={styles.statCard}>
            <Text style={styles.statVal}>N°1</Text>
            <Text style={styles.statLbl}>Classement</Text>
          </View>
        </View>

        {/* Mon business */}
        <Text style={styles.secLbl}>Mon business</Text>
        <View style={styles.grp}>
          <OptionRow icon={<IcoGrid />}   title="Ma vitrine"     subtitle="Produits, photos, horaires" onPress={onStore} />
          <OptionRow icon={<IcoTrend />}  title="Ma visibilité"  subtitle="Forfait actif · expire dans 47j" onPress={onVisibility} />
          <OptionRow icon={<IcoDollar />} title="Mes revenus"    subtitle="Rapports & statistiques" last />
        </View>
        ...
        <View style={styles.grp}>
          <OptionRow
            icon={<IcoBell />} title="Notifications" subtitle="Nouvelles commandes, relances"
            end="toggle" toggled={notifOn} onToggle={() => setNotifOn(v => !v)}
          />
          <OptionRow icon={<IcoCard />} title="Mon numéro marchand" subtitle="Wave / Orange Money" last />
        </View>
        ...
        <Text style={styles.version}>LASSİ Pro v1.0.0</Text>
      </ScrollView>
    </View>
  );
}
