-- Abaisse le montant minimum de commande à 1 FCFA (était 10 FCFA).
-- Toute commande avec un prix_base >= 1 est acceptée.
...
BEGIN
  ...
  -- Minimum 1 FCFA (pas de plafond inférieur arbitraire)
